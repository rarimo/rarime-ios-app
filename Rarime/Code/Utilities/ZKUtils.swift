...
class ZKUtils {
    ...
    public static func calcWtnsRegisterIdentity_1_160_3_3_576_200_NA(
        _ descriptionFileData: Data,
        _ privateInputsJson: Data
    ) throws -> Data {
#if targetEnvironment(simulator)
        ...
        let result = witnesscalc_registerIdentity_1_160_3_3_576_200_NA(
            (descriptionFileData as NSData).bytes, UInt(descriptionFileData.count),
            (privateInputsJson as NSData).bytes, UInt(privateInputsJson.count),
            wtnsBuffer, wtnsSize,
            errorBuffer, ERROR_SIZE
    ...
    public static func calcWtnsRegisterIdentity_21_256_3_3_336_232_NA(
        _ descriptionFileData: Data,
        _ privateInputsJson: Data
    ) throws -> Data {
#if targetEnvironment(simulator)
        ...
        let result = witnesscalc_registerIdentity_21_256_3_3_336_232_NA(
            (descriptionFileData as NSData).bytes, UInt(descriptionFileData.count),
            (privateInputsJson as NSData).bytes, UInt(privateInputsJson.count),
            wtnsBuffer, wtnsSize,
            errorBuffer, ERROR_SIZE
    ...
    public static func calcWtnsRegisterIdentity_24_256_3_4_336_232_NA(
        _ descriptionFileData: Data,
        _ privateInputsJson: Data
    ) throws -> Data {
#if targetEnvironment(simulator)
        ...
        let result = witnesscalc_registerIdentity_24_256_3_4_336_232_NA(
            (descriptionFileData as NSData).bytes, UInt(descriptionFileData.count),
            (privateInputsJson as NSData).bytes, UInt(privateInputsJson.count),
            wtnsBuffer, wtnsSize,
            errorBuffer, ERROR_SIZE
    ...
    public static func calcWtnsRegisterIdentity_1_256_3_3_576_248_NA(
        _ descriptionFileData: Data,
        _ privateInputsJson: Data
    ) throws -> Data {
#if targetEnvironment(simulator)
        ...
        let result = witnesscalc_registerIdentity_1_256_3_3_576_248_NA(
            (descriptionFileData as NSData).bytes, UInt(descriptionFileData.count),
            (privateInputsJson as NSData).bytes, UInt(privateInputsJson.count),
            wtnsBuffer, wtnsSize,
            errorBuffer, ERROR_SIZE
    ...
    public static func calcWtnsRegisterIdentity_20_256_3_3_336_224_NA(
        _ descriptionFileData: Data,
        _ privateInputsJson: Data
    ) throws -> Data {
#if targetEnvironment(simulator)
        ...
        let result = witnesscalc_registerIdentity_20_256_3_3_336_224_NA(
            (descriptionFileData as NSData).bytes, UInt(descriptionFileData.count),
            (privateInputsJson as NSData).bytes, UInt(privateInputsJson.count),
            wtnsBuffer, wtnsSize,
            errorBuffer, ERROR_SIZE
    ...
    public static func calcWtnsRegisterIdentity_21_256_3_3_576_232_NA(
        _ descriptionFileData: Data,
        _ privateInputsJson: Data
    ) throws -> Data {
#if targetEnvironment(simulator)
        ...
        let result = witnesscalc_registerIdentity_21_256_3_3_576_232_NA(
            (descriptionFileData as NSData).bytes, UInt(descriptionFileData.count),
            (privateInputsJson as NSData).bytes, UInt(privateInputsJson.count),
            wtnsBuffer, wtnsSize,
            errorBuffer, ERROR_SIZE
    ...
    public static func calcWtnsRegisterIdentity_11_256_3_5_576_248_1_1808_4_256(
        _ descriptionFileData: Data,
        _ privateInputsJson: Data
    ) throws -> Data {
#if targetEnvironment(simulator)
        ...
        let result = witnesscalc_registerIdentity_11_256_3_5_576_248_1_1808_4_256(
            (descriptionFileData as NSData).bytes, UInt(descriptionFileData.count),
            (privateInputsJson as NSData).bytes, UInt(privateInputsJson.count),
            wtnsBuffer, wtnsSize,
            errorBuffer, ERROR_SIZE
    ...
    public static func calcWtnsRegisterIdentity_10_256_3_3_576_248_1_1184_5_264(
        _ descriptionFileData: Data,
        _ privateInputsJson: Data
    ) throws -> Data {
#if targetEnvironment(simulator)
        ...
        let result = witnesscalc_registerIdentity_10_256_3_3_576_248_1_1184_5_264(
            (descriptionFileData as NSData).bytes, UInt(descriptionFileData.count),
            (privateInputsJson as NSData).bytes, UInt(privateInputsJson.count),
            wtnsBuffer, wtnsSize,
            errorBuffer, ERROR_SIZE
