#ifndef WITNESSCALC_REGISTERIDENTITYUNIVERSAL_H
#define WITNESSCALC_REGISTERIDENTITYUNIVERSAL_H
...
int
witnesscalc_registerIdentityUniversal(
...
#endif // WITNESSCALC_REGISTERIDENTITYUNIVERSAL_H
